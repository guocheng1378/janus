...
[![libxposed](https://img.shields.io/badge/libxposed-API%20101-blue)](https://github.com/libxposed/api)
...
- **自定义音乐卡片** — 用自定义 MAML 模板替换官方音乐卡片，可选歌词滚动适配
- **歌词 Hook 规则** — 通过 JSON 规则引擎按应用管理歌词 Hook。导入社区提供的规则文件，即可在背屏显示任意音乐应用的实时歌词（TTML/LRC 格式），支持按应用导入、启用/禁用和删除
