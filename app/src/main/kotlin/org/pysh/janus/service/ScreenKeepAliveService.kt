...
class ScreenKeepAliveService : Service() {
    ...
    companion object {
        ...
        fun start(context: Context, intervalSeconds: Int = DEFAULT_INTERVAL) {
            val intent = Intent(context, ScreenKeepAliveService::class.java)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val seconds = intent?.getIntExtra(EXTRA_INTERVAL, DEFAULT_INTERVAL)
